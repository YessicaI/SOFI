...
<?php 
                    ...
                    $conexion = db();
					$str="SELECT * FROM animacion where ID=".$_GET['id'];
						  ...
						  <div class="row" align="center">
						   ...
						   <br>
        					<div class="row" align="left">
            					<div class="col-md-6">
                                <div class="panel panel-default">
								<h5><img src="img/animacion2.png" width="30" height="30"> Nombre: <h8><?php echo $filas['nombre'];?></h8></h5>
								...
								<h5><img src="img/iconoCorreo.png" width="30" height="30">Correo: <h8><?php echo $filas['correo'];?></h8></h5>
								...
								<h5><img src="img/iconoPaquete.png" width="30" height="30">Paquete de servicio que ofrece: <h8><?php echo $filas['paquete'];?></h8></h5>
								<h5><img src="img/iconoPrecio.png" width="30" height="30">Precio del paquete que ofrece: <h8><?php echo $filas['precio'];?></h8></h5>
								</div>
                                </div>
