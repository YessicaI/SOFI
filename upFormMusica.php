			...
			<div class="col-md-12">
				<div class="panel panel-sofi">
					<div class="panel-default">
						<div class="row" align="center">
							<div class="col-md-12">
								<img src="img/animacion2.png" width="100" height="100"></a><br>
						 		<h4><center>Actualiza información de proveedor de música</center></h4>
							</div>	
						</div>
					<?php 
					...
					while ($filas=mysqli_fetch_assoc($consulta)) 
					{
						...
						<div class="row" align="center">
							<div class="col-md-4">
								...
								<div class="col-md-2">
									<form action="actualizarMusica.php?ID=<?php echo $filas['ID']; ?>" method="POST">
										<input type="hidden" value="ID=<?php echo $filas['ID']; ?>" name="ID">
											<button type="submit"  class="btn btn-default"><img src="img/actualizar.png" width="50" height="50"><span aria-hidden="true"></span></button>
									</form>
								</div>
							<div class="col-md-12">
