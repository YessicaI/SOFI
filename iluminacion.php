        ...
        <div class="row" align="center">
            <div class="col-md-12" >
                <div class="panel panel-default">
                     <img src="img/iluminacioon.png" alt="">
                     <br><br>
                     <h7><center>Encontraras renta de iluminación para fiestas, como leds, pantallas, todo para ambientar tu 
					...
					{?>
                            ...
                            <div class="col-md-3">
                             <div class="panel panel-detalle">
                                <img src="<?php  echo $filas['imagen'];?>" alt=""  width="200" height="140" >
                                <h3><?php echo $filas['nombre'];?></h3>
								<h5><?php echo $filas['descripción'];?></h5><br>
								<a href="detalleIluminacion.php?id=<?php echo $filas['id']?>"><h2>ver</h2></a>
							</div>
                             <br>
                             <br>
