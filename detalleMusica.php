...
<?php 
                    ...
                    $conexion = db();
					$str="SELECT * FROM musica where ID=".$_GET['id'];
						 ...
						 <div class="row" align="center">
						   ...
						   <br>
        					<div class="row" align="left">
            					<div class="col-md-6">
								<div class="panel panel-default">
								<h5><img src="img/iconoNegocio.png" width="30" height="30"> Nombre: <h8><?php echo $filas['nombre'];?></h8> </h5>
								...
								<h5><img src="img/iconoClasificacion.png" width="30" height="30">Género musical: <h8><?php echo $filas['clasificación'];?></h8></h5>
