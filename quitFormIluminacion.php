			...
			<div class="col-md-12">
				<div class="panel panel-sofi">
					<div class="panel-default">
						<div class="row" align="center">
							<div class="col-md-12">
								<img src="img/iluminacion.jpg" width="300" height="100"></a><br>
						 		<h4><center>Elimina proveedor de servicio iluminación para fiestas</center></h4>
							</div>	
						</div>
					<?php 
					...
					while ($filas=mysqli_fetch_assoc($consulta)) 
					{
						...
						<div class="row" align="center">
							<div class="col-md-4">
								...
								<div class="col-md-2">
									<form action="eliminarIluminacion.php?id=<?php echo $filas['id']; ?>" method="POST">
