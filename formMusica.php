						...
						<div class="col-sm-10 col-sm-offset-5">
							<div class="panel panel-sofi">
								<div class="panel-heading">
									<img src="img/musi.png" width="100" height="100"></a><br>
									Ingresa un nuevo servicio de música
								</div>
								<div class="panel-body">
									<form action="addMusica.php" method="post" enctype="multipart/form-data">
										...
										<div class="form-group">
											<h8><img src="img/iconoMusical.png" width="30" height="30">Ingresa género musical:</h8>
											<input type="text" class="form-control" placeholder="Género Musical" name="clasificación" required>
										</div>
										<div class="form-group">
										...
										<div class="form-group">
											...
											<input type="text" class="form-control" placeholder="Precio del paquete" name="precio" >
										</div>		
										<div class="form-group">
