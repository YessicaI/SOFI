        ...
        <div class="row" align="center">
            <div class="col-md-12" >
                <div class="panel panel-default">
                     <img src="img/reposteriaa.png" alt="">
                     <br><br>
                     <h7><center>Encontraras pasteles y todo tipo de postres para tu 
					...
					{?>
                            ...
                            <div class="col-md-3">
                             <div class="panel panel-detalle">
								...
								<a href="detalleReposteria.php?id=<?php echo $filas['id']?>"><h2>ver</h2></a>
							</div>
                            </div>
