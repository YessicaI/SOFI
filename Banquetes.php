...
<body>
    <div class="container">
        ...
        <div class="row" align="center">
            <div class="col-md-12" >
                   <?php include'carouselBanquetes.php'; ?>
            </div>
        </div>
        <br>
        <br>
        <div class="row" align="center">
            <div class="col-md-12" >
                <div class="panel panel-default">
                     ...
                     <br><br>
                     <h7><center>Encontraras banquetes que se adapten a las necesidades de tu fiesta</center></h7>
                </div>
            </div>
        </div>
        <br>
        <br>
         ...
         <!--Empieza codigo de iconos de paquetes-->
           <div class="row">
                <div class="col-md-3">
                    <P align="Center"><a href="reposteria.php"><img src="img/banquete/iconoReposteria.png" alt="" width="300" height="300"></a></p>
                </div>
                 <div class="col-md-3">
                    <P align="Center"><img src="img/banquete/iconoClasico.png" alt="" width="300" height="300"></p>
                </div>
                 <div class="col-md-3">
                    <P align="Center"><img src="img/banquete/iconoBuffet.png" alt="" width="300" height="300"></p>
                </div>
                 <div class="col-md-3">
                    <P align="Center"><img src="img/banquete/iconoInformal.png" alt="" width="300" height="300"></p>
                </div>
