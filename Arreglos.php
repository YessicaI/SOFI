...
<body>
    <div class="container">
        ...
        <div class="row" align="center">
            <div class="col-md-12" >
                   <?php include'carouselArreglo.php'; ?>
            </div>
        </div>
        <br>
        <br>
         ...
         <!--Empieza codigo de iconos de paquetes-->
           <div class="row">
                <div class="col-md-3">
                    <P align="Center"><img src="img/arreglo/iconoBelleza.png" alt="" width="300" height="300"></p>
                </div>
                <div class="col-md-3">
                    <P align="Center"><a href="arreglosFlorales.php"><img src="img/arreglo/iconoFloral.png"  width="300" height="300"></a></p>
                </div>
                <div class="col-md-3">
                    <P align="Center"><img src="img/arreglo/iconoRecuerdo.png" alt="" width="300" height="300"></p>
                </div>
                <div class="col-md-3">
                    <P align="Center"><img src="img/arreglo/iconoDecoración.png" alt="" width="300" height="300"></p>
                </div>
