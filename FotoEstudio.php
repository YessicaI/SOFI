    ...
    <div class="container">
        ...
        <br>
         ...
         <!--Empieza codigo de iconos de paquetes-->
           <div class="row">
                <div class="col-md-6">
                    <P align="Center"><img src="img/fotoEstudio/iconoFoto.png" alt="" width="400" height="400"></p>
                </div>
                <div class="col-md-6">
                    <P align="Center"><img src="img/fotoEstudio/iconoVideo.png" alt="" width="400" height="400"></p>
                </div>
     </div>
