			...
			<div class="col-md-12">
				<div class="panel panel-sofi">
					<div class="panel-default">
						<div class="row" align="center">
							<div class="col-md-12">
								<img src="img/postre.jpg" width="350" height="140"></a><br>
						 		<h4><center>Elimina repostería</center></h4>
							</div>	
						</div>
					<?php 
					...
					while ($filas=mysqli_fetch_assoc($consulta)) 
					{
						...
						<div class="row" align="center">
							<div class="col-md-4">
								...
								<div class="col-md-2">
									<form action="eliminarReposteria.php?id=<?php echo $filas['id']; ?>" method="POST">
