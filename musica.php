        ...
        <div class="row" align="center">
            <div class="col-md-12" >
                <div class="panel panel-default">
                     <img src="img/musicaa.png" alt="">
                     <br><br>
                     <h7><center>Encontraras grupos musicales, mariachis, dj, sonidos, todo lo que necesitas para ambientar tu 
					...
					{?>
                            ...
                            <div class="col-md-3">
                             <div class="panel panel-detalle">
                                <img src="<?php  echo $filas['imagen'];?>" alt=""  width="140" height="120" >
                                <h3><?php echo $filas['nombre'];?></h3><br>
								<h5><?php echo $filas['descripción'];?></h5><br>
								<a href="detalleMusica.php?id=<?php echo $filas['id']?>"><h2>ver</h2></a>
							</div>
                            </div>
