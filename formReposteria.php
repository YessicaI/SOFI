						...
						<div class="col-sm-10 col-sm-offset-5">
							<div class="panel panel-sofi">
								<div class="panel-heading">
									<img src="img/reposteria.png" width="90" height="100"></a><br>
									    Ingresa negocio de repostería
								</div>
								<div class="panel-body">
									<form action="addReposteria.php" method="post" enctype="multipart/form-data">
										<div class="form-group">
											<h8><img src="img/iconoNegocio.png" width="30" height="30"> Ingresa nombre del proveedor o negocio:</h8>
											<input type="text" class="form-control" placeholder="Nombre" name="nombre" required >
										</div>
                                        	<div class="form-group">
											<h8><img src="img/imagen.png" width="30" height="30"> Ingresa imagen:</h8>
										...
										<div class="form-group">
											<h8><img src="img/iconoHorario.png" width="30" height="30">Ingresa horario:</h8>
											<input type="text" class="form-control" placeholder="Horario de atención" name="horario" required>
										</div>
                                        	<div class="form-group">
											<h8><img src="img/iconoMenu.png" width="30" height="30">Ingresa menú que ofrece:</h8>
											<input type="text" class="form-control" placeholder="Menú de postre" name="menú"  required >
										</div>		
										<div class="form-group">
											<h8><img src="img/iconoPrecio.png" width="30" height="30">Ingresa precio del menú anterior:</h8>
