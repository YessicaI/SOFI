    ...
    <div class="container">
        ...
        <br>
         ...
         <!--Empieza codigo de iconos de paquetes-->
           <div class="row">
                <div class="col-md-3">
                    <P align="Center"><img src="img/salon/iconoPalapa.png" alt="" width="300" height="300"></p>
                </div>
                <div class="col-md-3">
                    <P align="Center"><img src="img/salon/iconoJardin.png" alt="" width="300" height="300"></p>
                </div>
                <div class="col-md-3">
                    <P align="Center"><img src="img/salon/iconoSalon.png" alt="" width="300" height="300"></p>
                </div>
                <div class="col-md-3">
                    <P align="Center"><img src="img/salon/iconoAlberca.png" alt="" width="300" height="300"></p>
                </div>
