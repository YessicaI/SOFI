...
<body>
    <div class="container">
        ...
        <div class="row" align="center">
            <div class="col-md-12" >
                   <?php include'carouselTienda.php'; ?>
            </div>
        </div>
        <br>
        <br>
         ...
         <!--Empieza codigo de iconos de paquetes-->
           <div class="row">
                <div class="col-md-3">
                    <P align="Center"><img src="img/tienda/iconoDulce.png" alt="" width="300" height="300"></p>
                </div>
                <div class="col-md-3">
                    <P align="Center"><img src="img/tienda/iconoGlobo.png" alt="" width="300" height="300"></p>
                </div>
                <div class="col-md-3">
                    <P align="Center"><img src="img/tienda/iconoDesechable.png" alt="" width="300" height="300"></p>
                </div>
                <div class="col-md-3">
                    <P align="Center"><img src="img/tienda/iconoRegalo.png" alt="" width="300" height="300"></p>
                </div>
