						...
						<div class="col-sm-10 col-sm-offset-5">
							<div class="panel panel-sofi">
								<div class="panel-heading">
									<img src="img/ilu.png" width="100" height="100"></a><br>
									Ingresa un nuevo servicio de iluminación
								</div>
								<div class="panel-body">
									<form action="addIluminacion.php" method="post" enctype="multipart/form-data">
